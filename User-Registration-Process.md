...
# Operation
## RSS-feed
To stay up to date about new features or occurring disturbances we highly advise you to use the RSS feed. Please follow the following instruction to insert the RSS Feed of the Journey-Service Blog: [Instruction RSS Feed](RSS Subscription-Instruction.pdf)
